    ...
    <div className="flex flex-col w-full h-auto bg-yellow select-none">
      ...
      <div className="pt-10 mb-10 px-10">
        ...
        <div className="w-full rounded-2xl shadow-lg bg-white py-5 px-4">
          <div className="font-museo text-center text-black">
              ...
              <div className="flex justify-center items-center space-x-4">
                {countdown.days > 0 ? (
                  <div className="text-center">
                    <div className="text-5xl font-light w-15 tabular-nums">
                      {pad(countdown.days)}
                    </div>
      ...
      <div className="flex flex-col w-full rounded-t-4xl bg-white items-center pt-13 px-10">
        ...
        >
          ...
          <span className="font-semibold font-museo text-sm text-black">
            {t.voteBtn}
          </span>
        </a>
        ...
        <div className="flex flex-col items-center">
          ...
          <span className="font-museo text-center text-dgray text-4xl mb-2">
            {voterCount !== null
            ...
            {candidatesWithImages.map((candidate, idx) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    <span className="font-museo font-semibold text-[0.625rem] leading-tight text-white">
                      {t.numberLabel}
                    </span>
                    <span className="font-museo text-5xl font-normal text-white">
                      {idx + 1}
                    </span>
                  </div>
