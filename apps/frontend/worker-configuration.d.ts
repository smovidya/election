/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 87a042ac580c264c04cfa3b3e63ee3a1)
// Runtime types generated with workerd@1.20260504.1 2026-05-05 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	interface ProductionEnv {
		ENVIRONMENT: "production";
		PUBLIC_BACKEND_URL: "https://election-api.vidyachula.org";
	}
	interface StagingEnv {
		ENVIRONMENT: "staging";
		PUBLIC_BACKEND_URL: "https://election-api-staging.vidyachula.org";
	}
	interface Env {
